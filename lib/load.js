...
function sendsessiondata(sendaction="Usersessiondata",message=''){
	...
	switch (sendaction) {
		case "Usersessiondata":
			sessionevent = new CustomEvent("Usersessiondata", {detail: {data: JSON.stringify(sessiondata)}, bubbles: false, cancelable: false});
			break;
		case "AuthenticatedUsersessiondata":
			sessionevent = new CustomEvent("AuthenticatedUsersessiondata", {detail: {data: JSON.stringify(sessiondata)}, bubbles: false, cancelable: false});
			break;
		case "Alertmessagedata":
			sessionevent = new CustomEvent("Alertmessagedata", {detail: {data: JSON.stringify(message)}, bubbles: false, cancelable: false});
			break;
	}
