		...
		showTooltipEditSection: function (nodeData) {
			try {
				...
				let tooltipBtnHtml = '	<div class="uda-recording" style="text-align: center;">'
					+ '		<input type="text" id="uda-edited-tooltip" name="uda-edited-tooltip" class="uda-form-input" placeholder="Custom Tooltip (Optional)" style="width:60% !important;" value="' + toolTipText + '">'
					+ '		<span>'
