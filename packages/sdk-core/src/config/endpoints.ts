...
export const ENDPOINT = {
    ...
    apiHostDev: 'http://localhost:8080',
    apiHostProd: 'http://localhost:8080',
    Search: `${CONFIG.apiHost}/api/search`,
    SearchWithPermissions: `${CONFIG.apiHost}/api/search`,
    fetchRecord: `${CONFIG.apiHost}/api/fetch`,
    SpecialNodes: `${CONFIG.apiHost}/api/specialnodes`,
    ClickStream: `${CONFIG.apiHost}/api/clickstream`,
    Click: `${CONFIG.apiHost}/api/click`,
    UpdateClick: `${CONFIG.apiHost}/api/updateclick`,
    DeleteRecording: `${CONFIG.apiHost}/api/deleterecording`,
    UpdateRecording: `${CONFIG.apiHost}/api/updaterecording`,
    RecordSequence: `${CONFIG.apiHost}/api/recordsequence`,
    RecordSequenceData: `${CONFIG.apiHost}/api/recordsequencedata`,
    ProfanityCheck: `${CONFIG.apiHost}/api/profanitycheck`,
    TranslateText: `${CONFIG.apiHost}/api/translate`,
    SessionKey: `${CONFIG.apiHost}/api/sessionkey`,
    UserId: `${CONFIG.apiHost}/api/userid`,
    Vote: `${CONFIG.apiHost}/api/vote`,
    VoteRecord: `${CONFIG.apiHost}/api/getvote`,
    Statuses: `${CONFIG.apiHost}/api/statuses`
};
