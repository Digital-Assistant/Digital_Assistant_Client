...
exports.ENDPOINT = exports.CONFIG = void 0;
exports.CONFIG = {
    apiHost: 'http://localhost:8080',
    apiHostDev: 'http://localhost:8080',
    apiHostProd: 'http://localhost:8080',
    UDA_DATA_KEY: "udaData",
    current: "TEST",
    UDADebug: false,
    ...
    get enableNodeTypeSelection() {
        return exports.CONFIG.multilingual.enabled;
    },
    cspUserAcceptance: {
...
exports.ENDPOINT = {
    ...
    apiHostDev: 'http://localhost:8080',
    apiHostProd: 'http://localhost:8080',
    Search: "".concat(exports.CONFIG.apiHost, "/api/search"),
    SearchWithPermissions: "".concat(exports.CONFIG.apiHost, "/api/search"),
    fetchRecord: "".concat(exports.CONFIG.apiHost, "/api/fetch"),
    SpecialNodes: "".concat(exports.CONFIG.apiHost, "/api/specialnodes"),
    ClickStream: "".concat(exports.CONFIG.apiHost, "/api/clickstream"),
    Click: "".concat(exports.CONFIG.apiHost, "/api/click"),
    UpdateClick: "".concat(exports.CONFIG.apiHost, "/api/updateclick"),
    DeleteRecording: "".concat(exports.CONFIG.apiHost, "/api/deleterecording"),
    UpdateRecording: "".concat(exports.CONFIG.apiHost, "/api/updaterecording"),
    RecordSequence: "".concat(exports.CONFIG.apiHost, "/api/recordsequence"),
    RecordSequenceData: "".concat(exports.CONFIG.apiHost, "/api/recordsequencedata"),
    ProfanityCheck: "".concat(exports.CONFIG.apiHost, "/api/profanitycheck"),
    TranslateText: "".concat(exports.CONFIG.apiHost, "/api/translate"),
    SessionKey: "".concat(exports.CONFIG.apiHost, "/api/sessionkey"),
    UserId: "".concat(exports.CONFIG.apiHost, "/api/userid"),
    Vote: "".concat(exports.CONFIG.apiHost, "/api/vote"),
    VoteRecord: "".concat(exports.CONFIG.apiHost, "/api/getvote"),
    Statuses: "".concat(exports.CONFIG.apiHost, "/api/statuses")
};
