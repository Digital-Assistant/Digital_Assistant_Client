export const specialNodes = {
  ...
  "dropDowns": {
    ...
    "classes": ['cke_notifications_area', 'aui-list', 'herknl', 'ghx-dropdown-trigger'],
    "attributes": []
  },
  "datePicker": {
    "tags": ['ngb-datepicker', 'ngb-datepicker', 'ngx-daterangepicker-material', 'mat-datepicker-content'],
    "classes": [],
    "attributes": ['uib-datepicker-popup-wrap']
  },
  "specialNodes": {
