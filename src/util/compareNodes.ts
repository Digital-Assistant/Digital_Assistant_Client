  ...
  for (let key in recordedNode) {
    ...
    */
    ...
    if (compareNode.hasOwnProperty(key) && (typeof recordedNode[key] === 'object') && (typeof compareNode[key] === 'object')) {
      ...
      compareNode[key] = compareNode[key].replace(' ng-star-inserted', '').replace('disabled', '').replace('writeInput');
      recordedNode[key] = recordedNode[key].replace(' ng-star-inserted', '').replace('disabled', '').replace('writeInput');
