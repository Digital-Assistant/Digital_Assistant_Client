...
export const ENDPOINT = {
  ...
  Search: `http://localhost:3003/search/all?query=#keyword#&domain=#domain#&page=#page#&userSessionId=#userSessionId#`,
  ...
  SearchWithPermissions: `http://localhost:3003/search/all?query=#keyword#&domain=#domain#&page=#page#&additionalParams=#additionalParams#&userSessionId=#userSessionId#`,
