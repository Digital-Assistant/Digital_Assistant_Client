...
function loginWithBrowser() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        browserVar.identity.getProfileUserInfo({ accountStatus: 'ANY' }, function (data) {
            return __awaiter(this, void 0, void 0, function* () {
                if (data.id !== '' && data.email !== "") {
                    sessionData.authenticated = true;
                    sessionData.authdata = data;
                    UDADigestMessage(sessionData.authdata.id, "SHA-512").then((encryptedid) => __awaiter(this, void 0, void 0, function* () {
                        sessionData.authdata.id = encryptedid;
                        UDADigestMessage(sessionData.authdata.email, "SHA-512").then((encryptedemail) => __awaiter(this, void 0, void 0, function* () {
                            sessionData.authdata.email = encryptedemail;
                            yield bindAuthenticatedAccount();
                        }));
                    }));
                }
                else {
                    yield sendSessionData("UDAAlertMessageData", "login");
                }
            });
        });
...
browserVar.runtime.onMessage.addListener(function (request, sender, sendResponse) {
    return __awaiter(this, void 0, void 0, function* () {
        if (request.action === "getusersessiondata" || request.action === "UDAGetNewToken") {
            browserVar.storage.local.get([cookieName], function (storedSessionData) {
                return __awaiter(this, void 0, void 0, function* () {
                    if (browserVar.runtime.lastError) {
                        ...
                        if (storedSessionData.hasOwnProperty("sessionkey") && storedSessionData["sessionKey"] && typeof storedSessionData["sessionKey"] != 'object') {
                            ...
                            if (request.action === "UDAGetNewToken") {
                                ...
                                yield sendSessionData();
                            }
                            else {
                                yield loginWithBrowser();
                            }
                        }
            ...
            yield keycloakStore(request.data);
        }
    });
});
/**
...
function storeSessionData() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield browserVar.storage.local.set(storageData);
        return true;
    });
}
/**
 ...
 */
function getSessionKey(sendData = true) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield invokeApi(apiHost + "/user/getsessionkey", "GET", null, false);
        console.log(response);
        if (!response) {
            return response;
        }
        sessionData.sessionkey = response;
        yield storeSessionData();
        if (sendData) {
            yield sendSessionData();
        }
    });
...
function bindAuthenticatedAccount() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let response = yield invokeApi(apiHost + "/user/checkauthid", "POST", authdata);
        if (response) {
            yield bindAccount(response);
            return true;
        }
        else {
            return response;
...
function bindAccount(userAuthData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const authToken = yield invokeApi(process.env.tokenUrl + "user/token", "POST", payLoad);
            ...
            if (authToken && (authToken === null || authToken === void 0 ? void 0 : authToken.token)) {
                ...
                let response = yield invokeApi("/user/checkusersession", "POST", userSessionData);
                yield storeSessionData();
                yield sendSessionData("UDAAuthenticatedUserSessionData");
            }
            return true;
        }
        catch (e) {
