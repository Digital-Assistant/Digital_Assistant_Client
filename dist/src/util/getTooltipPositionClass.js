 ...
 * @returns object
 */
export const getTooltipPositionClass = (targetElement, tooltipElement) => {
    const availablePositions = ["right", "top", "left", "bottom"].slice();
    const screenSize = getScreenSize();
    const tooltipPos = getNodeCoordinates(tooltipElement, screenSize);
    const targetElementRect = targetElement === null || targetElement === void 0 ? void 0 : targetElement.getBoundingClientRect();
    let finalCssClass = "right";
    // Check for space to the right
    if (tooltipPos && targetElementRect.right + tooltipPos.width >
    ...
    if (tooltipPos && targetElementRect.bottom + tooltipPos.height >
        screenSize.page.height) {
        removeFromArray(availablePositions, "bottom");
    }
    if ((availablePositions === null || availablePositions === void 0 ? void 0 : availablePositions.length) > 0) {
        finalCssClass = availablePositions[0];
    }
    return finalCssClass;
};
//# sourceMappingURL=getTooltipPositionClass.js.map